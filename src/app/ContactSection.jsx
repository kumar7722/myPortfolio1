...
<div data-aos="zoom-in-up" className="mt-5 w-1/3 mx-auto border-2 border-reactColor rounded p-4">
      <form onSubmit={onSubmit} className='w-full'>
        <div className="mb-3">
          ...
          <input className="form-control border border-reactColor bg-backgroundFirst" type="text" id="name" required />
        </div>
        <div className="mb-3">
       ...
       <Tooltip color="reactColor" content="Whatsapp redirect with form content">
       <button variant="flat" type="submit" class=" relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
...
<Image
      ...
      <Tooltip color="reactColor" content="Email Redirect with form content">
