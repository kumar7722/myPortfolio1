...
<a href="https://twitter.com/SONUKUM85858046" target="_blank" rel="noopener noreferrer">
  <span className="text-2xl"><RiTwitterXLine /></span>
      ...
      <div className='w-1/3 h-10 flex justify-center'><button onClick={() => window.open('https://drive.google.com/file/d/1w7_EsQ7G9z3Oy0ZClRtB57P5BlvaCXMe/view?usp=sharing', '_blank')} className="flex justify-center bg-reactColor text-white h-10 p-2 w-full rounded-md">
