...
<a href="https://twitter.com/SONUKUM85858046" target="_blank" rel="noopener noreferrer">
  <span className="text-2xl"><RiTwitterXLine /></span>
      ...
      <div className='w-1/3 h-10 flex justify-center'><button onClick={() => window.open('https://drive.google.com/file/d/1x4ebm8tgH5kFVcPcRsEl7dQSSuGL9vho/view?usp=drive_link', '_blank')} className="flex justify-center bg-reactColor text-white p-2 w-full rounded-md">
